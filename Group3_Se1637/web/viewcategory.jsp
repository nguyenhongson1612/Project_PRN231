...
<html lang="en">
    ...
    <body>
        ...
        <section id="product-detail" class="bg-light pb-5">
            <div class="container">
                <div class="pt-2 pb-2">
                    <p>Trang chủ &nbsp;» &nbsp;<a class="text-decoration-none text-dark" href="../viewcategory/${requestScope.c.getPattern()}">${requestScope.c.getName()}</a></p>
                </div>
                <hr class="mt-0 mb-3" />
                <div class="row mt-5">
            ...
            <div class="mobile-nav-container d-flex flex-column bg-white">
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item">
                     ...
                     <li class="list-group-item">
                        <a href="../article/huong-dan-dat-coc-17" class="text-decoration-none text-dark">LIÊN HỆ</a>
                    </li>
                    <c:if test="${sessionScope.account.getStatics() == 1}">
