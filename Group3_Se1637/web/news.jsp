...
<html lang="en">
    ...
    <body>
        ...
        <section class="product-section bg-light pt-5 pb-5">
            <div class="container">
                <c:forEach items="${requestScope.news}" var="entry2">
                    <c:if test="${entry2.key.stt ==1}">
                        <div class="product-section--header">
                            <div class="row">
                                <div class="col-md-4 ms-2">
                                    <div class="section-title position-relative pe-2 ps-2">
                                        <p class="mb-1">DANH MỤC</p>
                                        <c:set var = "string" value = "${fn:toUpperCase(entry2.key.groupname)}" />
                                        <a class="text-decoration-none text-dark" href="groupnews/${entry2.key.getPattern()}"><h5>${string}</h5></a>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <ul
                                    ...
                                    >
                                    <c:forEach var="i" items="${entry2.value}">
