                            ...
                            <div class="col-md-8">
                                ...
                                <form role="form" method="post">
                                    <div class="form-group">
                                        <label>Họ & Tên</label>
                                        <input type="text" name="name" required class="form-control" value="${c.name}" placeholder="Họ và tên">
                                    </div>
                                    <div class="form-group">
                                        <label>Email</label>
                                        <input type="text" name="email" required value="${c.email}" class="form-control">
                                    </div>                       
                                    <div class="form-group">
                                        <label>Số điện thoại</label>
                                        <input type="text" name="phone" required value="${c.phone}" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Địa chỉ</label>
                                        <input type="text" name="address" required value="${c.address}" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Quyền</label>
                                        <input type="text" name="role" required readonly value="Khách hàng" class="form-control">
                                    </div>
