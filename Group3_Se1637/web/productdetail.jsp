<%-- 
    Document   : productdeail
    Created on : Feb 7, 2023, 10:50:01 PM
    Author     : Anh Quan
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <section id="product-detail" class="bg-light pb-5">
            <div class="container">
                <div class="pt-2 pb-2">
                    <p>Trang chủ &nbsp;» &nbsp;
                        <a class="text-decoration-none text-dark" href="../viewcategory/${p.getCategory().getPattern()}">
                            ${p.getCategory().getName()}
                        </a> &nbsp; » &nbsp;  
                        <a class="text-decoration-none text-dark" href="../productdetail/${p.getParttern()}">${p.getName()}</a></p>
                </div>
                <hr class="mt-0 mb-3" />
                <div class="row mt-5">
                    <div class="d-none d-lg-block col-lg-3">
                        <h5 class="list-title text-white text-center p-1">
                            DANH MỤC SẢN PHẨM
                        </h5>
                        <ul class="list-group">
                            <c:forEach items="${requestScope.products}" var="entry">
                                <li class="list-group-item">
                                    <a href="../viewcategory/${entry.key.getPattern()}" class="main text-decoration-none fw-bold"
                                       >${entry.key.getName()}</a
                                    >
                                </li>
                                <c:forEach items="${entry.value}" var="i">
                                    <c:if test="${i.getStt()!=3}">
                                        <li class="list-group-item">
                                            <a href="../productdetail/${i.getParttern()}" class="text-decoration-none text-dark"
                                               >${i.getName()}</a
                                            >
                                        </li> 
                                    </c:if>
                    ...
                    <div class="col-12 col-lg-9 ps-lg-5 pe-lg-2">
                        <div class="row d-flex">
                            <div class="col-12 col-lg-7">
                                <c:if test="${p.getStt()!=3}">


                                    <div
                                        class="container bg-white d-flex justify-content-center align-items-center p-0 p-lg-5 big-img"
                                        >
                                        <img
                                            class="w-75"
                                            src="../img/${p.getPid()}/${p.getAvata()}"
                                            alt=""
                                            />
                                    </div>

                                    <ul
                                        class="w-100 d-flex justify-content-left align-items-center list-unstyled mt-2"
                                        >
                                        <c:forEach items="${requestScope.listimage}" var="i">
                                            <li class="small-img m-1 zoom-img">
                                                <img
                                                    class="w-100"
                                                    src="../img/${i.getProduct().getPid()}/${i.getLink()}"
                                                    alt=""
                                                    />
                                            </li>
                                        </c:forEach>
                            ...
                            <div class="col-12 col-lg-5 ps-lg-5">
                                <h1 class="fw-bold mb-3 mt-3 mt-md-0 fs-4">${p.getName()}</h1>
                                <p id="pid">Mã sản phẩm: ${p.getPid()}</p>
                                <c:if test="${p.getAction()==1}">
                                    <button class="btn btn-order text-white fw-bolder my-2 " >

                                        <a
                                            href="../deposit/dat-hang-${p.getParttern()}"
                                ...
                                <c:if test="${p.getAction()==2}">
                                    <button class="btn btn-danger text-white fw-bolder my-2">
                                ...
                                <ul class="social-list list-unstyled d-flex mt-5">
                                    <li class="me-5">
                                        <a href="https://www.facebook.com/" class="text-dark fs-6 text-decoration-none">
                                            <i class="fa-brands fa-facebook-f"></i>
                                            Share
                                        </a>
                                    </li>
                                    <li class="me-5">
                                        <a href="https://www.twitter.com/" class="text-dark fs-6 text-decoration-none">
                                            <i class="fa-brands fa-twitter"></i>
                                            Tweet
                                        </a>
                                    </li>
                                    <li class="me-5">
                                        <a href="https://www.google.com/" class="text-dark fs-6 text-decoration-none">
                        ...
                        <div class="mt-5">
                            <ul class="detail-list d-flex list-unstyled">
                                <li class="p-3 pt-2 pb-2 me-1 fw-bold chosen">CHI TIẾT</li>


                            </ul>
                            <div class="p-5 border">
                                <div class="detail-text p-2 bg-white">${p.getDescribe()}</div>
                            </div>
                        </div>
                        <section class="product-section bg-light pt-5">
                            <div class="product-section--header">
                                <div class="row">
                                    <div class="col-md-4 ms-0 ms-lg-2">
                                        <div class="section-title position-relative pe-2 ps-2">
                                            <h5>SẢN PHẨM KHÁC</h5>
                            ...
                            <div class="product-section--content pt-4">
                                <div class="row">
                                    <div class="col-12">
                                        <ul
                                            class="d-flex flex-wrap justify-content-left align-items-center list-unstyled w-100"
                                            >

                                            <c:forEach items="${requestScope.listp}" var="i">
                                                <c:if test="${(i.getPid().equals(p.getPid()))==false}">
