...
<html lang="en">
    ...
    <body>
        ...
        <div
            class="order-container d-flex align-items-center justify-content-between"
            >
            <form id="deposit"
                class="d-flex flex-column align-items-center w-100 border border-1 rounded-3 py-5 px-4"
                method="post"
                >
                <h3 class="mb-5 text-white">Đăng Kí Đặt Cọc</h3>
                <div class="col-12 mb-4">
                    <div class="input-group">
                        ...
                        <input
                            ...
                            required
                            value="${sessionScope.account.getName()}"
                            />
                    </div>
                </div>
                <div id="phone-group" class="col-12 mb-4">
                    <div class="input-group">
                        <div class="input-group-text">
                        ...
                        <input
                            ...
                            required
                            value="${sessionScope.account.getPhone()}"
                            />
                        <p class="error text-white position-absolute fw-bold"></p>
                    </div>
                </div>
                <div class="col-12 mb-4">
                    <div class="input-group">
                ...
                <div class="col-12 mb-4">
                    <div class="input-group">
                        ...
                        <input
                            ...
                            placeholder="Địa chỉ"
                            required
                            value="${sessionScope.account.getAddress()}"
                            />
                    </div>
                </div>

                <div class="col-12 d-flex justify-content-center mt-3">
                    <button type="submit" class="btn btn-orange text-white fw-bold w-50">Submit</button>
                </div>
            </form>
        </div>
