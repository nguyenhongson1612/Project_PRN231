<%-- 
    ...
    Created on : Feb 9, 2023, 9:30:47 PM
    Author     : ADMIN
--%>
...
<html>
    ...
    <body>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Thành viên: ${c.name}</h1>
                </div>
            </div><!--/.row-->
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="col-md-8">
                                ...
                                <form role="form" method="post">
                                    <div class="form-group">
                                        <label>Họ & Tên</label>
                                        <input type="text" name="name" required readonly class="form-control" value="${c.name}">
                                    </div>
                                    <div class="form-group">
                                        <label>Bằng cấp</label>
                                        <input type="text" name="degree" required readonly class="form-control" value="${c.degree}" >
                                    </div>
                                    <div class="form-group">
                                        <label>Email</label>
                                        <input type="text" name="email" required readonly value="${c.email}" class="form-control">
                                    </div>                       
                                    <div class="form-group">
                                        <label>Số điện thoại</label>
                                        <input type="text" name="phone" required readonly value="${c.phone}" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Địa chỉ</label>
                                        <input type="text" name="address" required readonly value="${c.address}" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Quyền</label>
                                        <input type="text" name="role" required readonly value="Nhân viên" class="form-control">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="repass" required class="form-control">
                                    </div>
