                ...
                <div class="row">
                    <ul
                        ...
                        <p  class="headline-item text-white ps-3 pe-3 text-center">
                            <a href="article/huong-dan-lien-he-16" class="text-decoration-none text-white"> Hướng dẫn đặt cọc </a>
                        </p>
                        <p class="headline-item text-white ps-3 pe-3 text-center">
                            <a href="article/huong-dan-dat-coc-17 " class="text-decoration-none text-white"> Liên hệ </a>
                        </p>
                    </ul>
                </div>  
            </div>
                ...
                <div class="container-fluid">
                    <div class="row w-100" id="navbarSupportedContent">
                        <ul
                            ...
                            <li class="nav-item me-4 ms-4">
                                <a class="nav-link text-white" href="article/gioi-thieu-cong-ty-vat-lieu-xay-dung-vietcorp-18">GIỚI THIỆU</a>
                            </li>
                            <li class="nav-item me-4 ms-4">
                                <a class="nav-link text-white" href="viewcategory/gach-op-lat-1">GẠCH ỐP LÁT</a>
                            </li>
                            <li class="nav-item me-4 ms-4">
                                <a class="nav-link text-white" href="viewcategory/thiet-bi-ve-sinh-4">THIẾT BỊ VỆ SINH</a>
                            </li>
        ...
        <section
            ...
            <div class="mobile-nav-container d-flex flex-column bg-white">
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item">
                        <a href="article/gioi-thieu-cong-ty-vat-lieu-xay-dung-vietcorp-18" class="text-decoration-none text-dark">GIỚI THIỆU</a>
                    </li>
                    <li class="list-group-item">
