            ...
            <div class="row">
                ...
                <form   id="submit-form"  method="post">
                    ...
                    <input 
                        ...
                        value="${requestScope.news.getSortdesc()}"
                        aria-describedby="basic-addon1"
                        />
                    <div class = "mb-3">
                        ...
                        <select  id ="news-type" class="form-select w-auto" aria-label="Type" name="groupnews">
                            ...
                            <c:forEach items="${requestScope.list}" var="c">
                                <c:if test="${requestScope.g.getGid() == c.getGid()}">
                                    <option value="${c.getGid()}" selected="">${c.getGroupname()}</option>
                                </c:if>
                                <c:if test="${requestScope.g.getGid() != c.getGid()}">
                    ...
                    <textarea id="summernote" name="content">${requestScope.news.getContent()}</textarea>

                    <div class = "d-flex justify-content-center my-5">
                        <div id ='avt' >
                            <div id = "avt-container" class = 'position-relative d-flex align-items-center justify-content-center'>
                                <c:if test="${requestScope.news.getAvata()!= null}">
                                    <button type="button" id ="avt-close-btn" class = "btn btn-danger position-absolute p-2 avt-btn rounded-0">
                                        <i class="fa-solid fa-xmark"></i>
                                    </button>
                                    <img src="image/news_avata/${requestScope.news.getAvata()}"/>
                                </c:if>
