                ...
                <div class="col-md-6 mx-auto mt-5">
                    <div class="payment">
                        ...
                        <div class="content">
                            ...
                            <p class = "my-3">Chúng tôi sẽ liên hệ tới số điện thoại hoặc email mà bạn cũng cấp.
                                Vui lòng kiểm tra email hoặc cuộc gọi để nhận tư vấn của chúng tôi  </p>
                            <a class="text-decoration-none " href="home">Trang Chủ</a>
                        </div>
