<%-- 
    ...
    Created on : Feb 7, 2023, 1:57:57 AM
    Author     : ADMIN
--%>
...
<html>
    ...
    <body>
        ...
        <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
            ...
            <ul class="nav menu">
                <li><a href="admin.jsp"><svg class="glyph stroked dashboard-dial"><use xlink:href="#stroked-dashboard-dial"></use></svg> Dashboard</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
            <div class="row">
                <ol class="breadcrumb">
                    ...
                    <li class="active">${i.getGroupname()}</li>
                </ol>
            </div><!--/.row-->

            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Danh mục: ${i.getGroupname()}</h1>
                </div>
            </div><!--/.row-->
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="col-md-8">       
                                <form role="form" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" required value="${i.getGroupname()}" class="form-control" placeholder="Tên nhóm tin...">
                                    </div>
